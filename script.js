document.addEventListener("DOMContentLoaded", function () {
  ...
  const projectCards = document.querySelector(".project-cards"); // Reference to the project cards container
  ...
  function handleClick() {
    ...
    video.src =
      "https://cdn.discordapp.com/attachments/1122169102941814865/1122597504681255013/vecteezy_animated-flying-through-the-stars-and-blue-and-red-in-space_8079146_731_1.MP4"; // Replace with the URL of the new video
    ...
    projectCards.style.display = "flex"; // Display the project cards
